export default {
    ...
    alertMoyen: "Médio",
    alertFaible: "Baixo",
    alertDescGrave: "(Acidente, agressão, mal-estar ...)",
    alertDescMoyen: "(quebrado, preso, roubo ...)",
    alertDescFaible: "(Perdido, incômodo, outro ...)",
    ...
    gdps1: "Malaise",
    gdps2: "Posição de segurança lateral",
    gdps3: "Hemorragia",
    gdps4: "Trauma",
    gdps5: "Burns",
    gdps7: "Ventilação artificial",
    gdps8: "Ettoufement adulto",
    ...
    settingsCSMDP: "Alterar sua senha",
    settingsChk1: "Notificação de alerta",
    settingsChangerAvatar: "Altere sua foto",
    settingsChangerPseudo: "Altere seu apelido",
    settingsLanguage: "Idioma",
    settingsSeDeco: "Desconecta",
