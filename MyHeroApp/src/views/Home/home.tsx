			...
			<TouchableOpacity onPress={props.onClick}>
				<View
					...
					<View
						...
						{props.fontAwesome && <FontAwesomeIcon icon={props.fontAwesome} size={25} style={{ color: "#ffffff" }} />}
					</View>
				</View>
			</TouchableOpacity>
		);
					...
					<View
						...
						<View style={{ marginTop: 15 }}>
							<AlertComponent
								onClick={() => {
									dispatch(setCacheNav("Home"));
									navigation.navigate("GDPS");
								}}
								fontAwesome={faFirstAid}
								color="#008b00"
								title={I18n.t("gdps")}
							/>
							<AlertComponent
