				...
				<View
					...
					<View
						...
						<Image
							...
							source={{
								uri: `http://176.31.230.112:3000/api/avatar/${props.identifier
									.toLowerCase()
	...
	return (
		<>
			...
			<View
				...
				<ScrollView>{returnAlerts(navigation)}</ScrollView>
			</View>
		</>
	);
};
