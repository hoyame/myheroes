			...
			<ScrollView>
				<View
					...
					<View
						...
						<AccountStats
							name={alertData.source}
							xp={userCache.xp}
							rate={userCache.rate}
							img={`http://176.31.230.112:3000/api/avatar/${alertData.identifier
								.toLowerCase()
					...
					<View
						...
						{photo == false && (
							<Image
								source={{ uri: `http://176.31.230.112:3000/api/avatar/alert-${alertData.identifier}?time=${new Date()}` }}
								style={{
									height: "99%",
									width: "99%",
									borderRadius: 10,
					...
					<BottomComponent
						title={I18n.t("alertPrendreAlert")}
						onClick={() => {
							_storeData();
