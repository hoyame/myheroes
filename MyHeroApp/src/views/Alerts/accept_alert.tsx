						...
						<View
							...
							<View
								...
								<Text
									...
									{alertDataSend.data.description}
								</Text>
							</View>
						</View>
					</View>
			...
			<View
				...
				<View
					...
					<View
						...
						<Image
							...
							source={{
								uri: `http://176.31.230.112:3000/api/avatar/${alertDataHelp.source
									.toLowerCase()
				...
				<View
					...
					{photo == false && (
						<Image
							source={{
								uri: `http://176.31.230.112:3000/api/avatar/alert-${alerts.data.identifier
									.toLowerCase()
									.replace(/^"(.+(?="$))"$/, "$1")}?time=${new Date()}`,
							}}
							style={{
				...
				<View style={{ marginBottom: 10 }}></View>
				<BottomComponent
					title={I18n.t("alertLancerItt")}
					onClick={() => Linking.openURL(`https://www.google.es/maps?q=${alerts.data.latitude},${alerts.data.longitude}`)}
				/>
				<View style={{ marginBottom: 10 }}></View>

				<BottomComponent
					title={I18n.t("alertAbbandoner")}
					onClick={() => {
