...
const AccountScreen = ({ navigation }) => {
				...
				<View
					...
					<View
						...
						<Image
							...
							source={{
								uri: `http://176.31.230.112:3000/api/avatar/${props.source
									.toLowerCase()
	...
	const returnAvis = () => {
		return AvisData.map((v, k) => <AvisProps key={k} {...v} />);
	};
									...
									<View
										...
										<View
											...
											<Image
												...
												source={{
													uri: `http://176.31.230.112:3000/api/avatar/${v.email
														.toLowerCase()
														.replace(/^"(.+(?="$))"$/, "$1")}?time=${new Date()}`,
												}}
											/>
